...
#'
#' This function estimates the number of significant digits in an unknown numerator and denominator in a division operation used to generate a value that (possibly) has values after the decimal place OR the number of digits to which an integer may have been rounded, depending on whether the input has values after the decimal place or is an integer. Negative values are treated as positive values so the negative of a number will returns the same value as its positive version. For values with at least one non-zero digit after a decimal place with no repeated series of digits detected, the function simply returns the total number of digits (ignoring trailing zeros) times -1. For example:
#' \itemize{
...
#' }
#' \emph{Obviously, values can appear to be rounded or repeating even when they are not!}
...
#' roundedFrom(0.111117)
#' roundedFrom(0.666)
#' roundedFrom(0.667)
#' roundedFrom(0.3334)
#' roundedFrom(0.121212)
#' roundedFrom(0.000678678678)
#' roundedFrom(0.678678678)
#' roundedFrom(0.678678679)
#' roundedFrom(0.1111)
#' roundedFrom(0.1111, minReps=5)
#' roundedFrom(0.121212)
#' roundedFrom(0.121212, minReps=4)
#' roundedFrom(234)
#' roundedFrom(100)
#' roundedFrom(70001)
#' roundedFrom(4E5)
